...
class PantsControllerTest < ActionController::TestCase
  ...
  test "should create pant" do
    assert_difference('Pant.count') do
      post :create, pant: { cuffs: @pant.cuffs, pant_name: @pant.pant_name, pleats: @pant.pleats, price: @pant.price, quantity: @pant.quantity }
    end
  ...
  test "should update pant" do
    put :update, id: @pant, pant: { cuffs: @pant.cuffs, pant_name: @pant.pant_name, pleats: @pant.pleats, price: @pant.price, quantity: @pant.quantity }
    assert_redirected_to pant_path(assigns(:pant))
  end
