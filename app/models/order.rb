class Order < ActiveRecord::Base
  attr_accessible :customer_id, :order_commission, :order_discount, :order_gross, :order_value, :altered, :refunded, :alt_ref_cost, :shirts_attributes, :suits_attributes, :pants_attributes, :others_attributes
  has_many :shirts
  has_many :suits
  has_many :pants
  has_many :others
